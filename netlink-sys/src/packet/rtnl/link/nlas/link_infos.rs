...
pub const IPVLAN: &str = "ipvlan";
pub const MACVLAN: &str = "macvlan";
pub const MACVTAP: &str = "macvtap";
pub const GRETAP: &str = "gretap";
pub const IP6GRETAP: &str = "ip6gretap";
pub const IPIP: &str = "ipip";
pub const SIT: &str = "sit";
pub const GRE: &str = "gre";
pub const IP6GRE: &str = "ip6gre";
pub const VTI: &str = "vti";
...
mod tests {
    ...
    #[test]
    fn parse_info_kind() {
        let info_kind_nla = NlaBuffer::new_checked(&BYTES[..12]).unwrap();
    ...
    fn parse_info_bridge() {
        let nlas = NlasIterator::new(&BYTES[16..]);
    ...
    #[test]
    fn parse() {
        let nla = NlaBuffer::new_checked(&BYTES[..]).unwrap();
